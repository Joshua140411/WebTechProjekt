...
kategorien.forEach(kategorie => {
    ...
    const relatedTutorials = getTutorialsZuKategorie(kategorie.name, tutorials);
    relatedTutorials.forEach(tutorial => {
        ...
        tutorial.kapitelliste.forEach(kap => {
            console.log(`    ${kap.dauer}   ${kap.name}:`);
            console.log(`        ↳${kap.beschreibung}`);
        });
    });
});